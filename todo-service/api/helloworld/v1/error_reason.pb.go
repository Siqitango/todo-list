...
const (
	...
	ErrorReason_TODO_UNSPECIFIED    ErrorReason = 2
	ErrorReason_TODO_NOT_FOUND      ErrorReason = 3
)
...
const file_helloworld_v1_error_reason_proto_rawDesc = "" +
	"\n" +
	" helloworld/v1/error_reason.proto\x12\rhelloworld.v1*d\n" +
	"\vErrorReason\x12\x17\n" +
	"\x13GREETER_UNSPECIFIED\x10\x00\x12\x12\n" +
	"\x0eUSER_NOT_FOUND\x10\x01\x12\x14\n" +
	"\x10TODO_UNSPECIFIED\x10\x02\x12\x12\n" +
	"\x0eTODO_NOT_FOUND\x10\x03BF\n" +
	"\rhelloworld.v1P\x01Z!todo-service/api/helloworld/v1;v1\xa2\x02\x0fAPIHelloworldV1b\x06proto3"
